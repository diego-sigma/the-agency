...
echo "  /pulse [N]                        — triage the latest tech news for your projects"
echo "  /parker                            — draft a PR description + pre-flight the diff (Parker)"
echo "  /earl-learn [repo]                — mine your past review comments to teach Earl"
